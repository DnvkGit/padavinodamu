// EXACT transliterator logic
        ...
        const gameWords = [
			'కరవాల:ఖడ్గము', 'కృపాణము:కరవాలము', 'అనుమానం:సందేహం  ', 'మరాళము:హంస', 'అవధూత:సన్యాసి', 'ఎండతాకు:వడదెబ్బ ',
			  ...
			  'విలుకాడు:ధనుర్ధరుడు', 'సంప్రేషము  :ఆజ్ఞ', 'కాటాగరు:పెద్ద త్రాసు తూచు వ్యక్తి', 'నడ్డిపూస:నడ్డికీలు ',
			  ...
			  'కలమంద :మందుచెట్టు', 'కృతఘ్నడు: మేలు మరచినవాఁు', 'కారుచిచ్చు:దావానలము', 'అంతశయ్యా :చావు / శ్మశానము',
			  ...
			  'జాతీఫల:జాజికాయ', 'తరుణుడు :కోడెకాడు', 'తక్కుబిక్కు:మంచి చెడ్డ', 'రామతమ్మ :నిబంధన ', 'సమున్నతి:అభివృద్ధి ',
